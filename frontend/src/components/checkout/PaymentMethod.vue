<template>
  <div class="payment-method-container">
    <h4 class="mb-4 font-weight-bold text-dark"><i class="fas fa-credit-card me-2"></i>Forma de Pagamento</h4>

    <div class="options-list">
      <!-- OPÇÃO MERCADO PAGO (ÚNICA OPÇÃO REAL) -->
      <div
    ...
    <div class="alert alert-primary border-0 shadow-sm mt-4 d-flex align-items-center p-3">
      ...
      <p class="small mb-0">
        Você será redirecionado para o ambiente seguro do <strong>Mercado Pago</strong> ao finalizar.
      </p>
    </div>
  </div>
</template>
