<template>
  <div class="gemini-chat-improved">
    ...
    <div class="chat-messages" ref="messagesContainer">
      ...
      >
        ...
        <div class="message-content">
          ...
          <div class="message-text markdown-content" v-else v-html="renderMarkdown(msg.content)"></div>
